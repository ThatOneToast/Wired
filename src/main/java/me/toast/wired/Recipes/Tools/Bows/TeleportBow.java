...
import me.toast.wired.Items.Tools.Bows.TeleportBowUtils;
...
public class TeleportBow {
    public static void TeleportBowRecipe(){
        //Bow ( Teleport ) ( EPIC )
        ShapedRecipe tpBow = new ShapedRecipe(new NamespacedKey(Wired.getPlugin(), "TeleportBow"), new ItemStack(TeleportBowUtils.createTeleportBow()));
